...
expect_true(all(c("yieldPixelGroup", "speciesCode", "canfi_species", "abbreviation", "EcoBoundaryID") %in% colnames(out1)))
# spatial matching
expect_true(all(out1$abbreviation[out1$yieldPixelGroup == 1] == "a"))
expect_true(all(out1$abbreviation[out1$yieldPixelGroup %in% c(3,4)] == "b"))
expect_false(all(out1$abbreviation[out1$yieldPixelGroup == 2] == "a"))
expect_true(all(c("a","b") %in% out1$abbreviation[out1$yieldPixelGroup == 2]))
...
expect_true(all(c("pixelGroup", "speciesCode", "canfi_species", "abbreviation", "EcoBoundaryID") %in% colnames(out2)))
